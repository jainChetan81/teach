...
- **2026-08-15 — his actual gap is the WHOLE codebase, front included.** Correction to the
  ...
  no exceptions.
- **2026-08-16 — default to file+line, not grep, for READING tasks.** He runs terminal
  commands fine; the objection was efficiency, not ability — sending him to `grep` when he
